...
3. Add these properties:
   ...
   - **`TRANSLATION_MODEL`** *(optional, defaults to `nvidia/nemotron-3-nano-30b-a3b`)*: any model identifier supported by NVIDIA NIM. Useful if you want to swap models without redeploying. The default is the text-only Nano variant; for the multimodal Omni variant use `nvidia/nemotron-3-nano-omni-30b-a3b-reasoning` (slower, larger, only worth it once Phase 5's voice modality work begins). The reasoning for the default and the eval methodology for picking a different one are recorded in [`docs/decisions/0007-translation-backend.md`](../docs/decisions/0007-translation-backend.md) and [`0008-open-model-eval-classical-tamil.md`](../docs/decisions/0008-open-model-eval-classical-tamil.md).
